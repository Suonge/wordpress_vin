...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'Wordpress_ThomasDaCosta_exo_vin_d49475a88d75879b6165_20220331105713_archive.zip';
	const ARCHIVE_SIZE		 = '57337183';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'd49475a-31105713';
    const SECONDARY_PACKAGE_HASH = '96311f8-31105713';
	const VERSION			 = '1.4.4';
